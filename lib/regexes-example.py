...
regexes = {
    ...
    'email_pass':re.compile(r'[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}:.*', re.I),
    ...
    'aws_api': re.compile(r'aws_access_key_id|aws_secret_access_key', re.I),
    ...
    'critical_keywords': [
        re.compile(r'youremail@gmail.com|somedomain.com', re.I)
    ],
